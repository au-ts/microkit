...
// use crate::{
//     capdl::{CapDLSpecContainer, TcbBoundSlot},
//     sel4::{Arch, ArmRiscvIrqTrigger, Config, X86IoapicIrqPolarity, X86IoapicIrqTrigger},
// };

use crate::{capdl::CapDLSpecContainer, sel4::Config};

pub fn write_report(_spec: &CapDLSpecContainer, _kernel_config: &Config, _output_path: &str) {
