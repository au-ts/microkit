...
use crate::{
    capdl::{
        spec::{capdl_obj_human_name, capdl_obj_physical_size_bits},
...
//         report_file
//             .write_all(format!("\t- TCB: '{}'\n", named_tcb_objects.name.unwrap()).as_bytes())
//             .unwrap();
...
//                     report_file
//                         .write_all(
//                             format!("\t\t\t-> {}: '{}'\n", prefix, object_name.unwrap()).as_bytes(),
//                         )
//                         .unwrap();
//                 }
//             }
...
//         report_file
//             .write_all(format!("\t- CNode: '{}'\n", named_cnode_object.name.unwrap()).as_bytes())
//             .unwrap();
...
//             report_file
//                 .write_all(format!("\t\t\t-> Object: '{}'\n", to_object.name.unwrap()).as_bytes())
//                 .unwrap();
//             // @billn revisit
...
//                             named_ioport_object.name.unwrap()
//                         )
//                         .as_bytes(),
//                     )
//                     .unwrap();
