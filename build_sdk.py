...
SUPPORTED_BOARDS = (
    ...
    BoardInfo(
        ...
        kernel_options={
            ...
            "KernelArmHypervisorSupport": True,
            "KernelArmVtimerUpdateVOffset": False,
            "KernelCustomDTSOverlay": "../seL4/src/plat/odroidc4/kernel-overlay-odroidc4_1.dts",
        },
        multikernels=2,
    ),
    BoardInfo(
        ...
        kernel_options={
            ...
            "KernelArmHypervisorSupport": True,
            "KernelArmVtimerUpdateVOffset": False,
            "KernelCustomDTSOverlay": "../seL4/src/plat/odroidc4/kernel-overlay-odroidc4_2.dts",
        },
        multikernels=2,
    ),
    BoardInfo(
