...
SUPPORTED_BOARDS = (
    ...
    BoardInfo(
        ...
        kernel_options={
            ...
            "KernelArmHypervisorSupport": True,
            "KernelArmVtimerUpdateVOffset": False,
            "KernelCustomDTSOverlay": "/home/freya/tor/seL4/src/plat/odroidc4/kernel-overlay-odroidc4_1.dts",
        },
        multikernels=2,
    ),
    BoardInfo(
        name="odroidc4_multikernel_2",
        arch=KernelArch.AARCH64,
        gcc_cpu="cortex-a55",
        loader_link_address=0x20000000,
        kernel_options={
            ...
            "KernelArmHypervisorSupport": True,
            "KernelArmVtimerUpdateVOffset": False,
            "KernelCustomDTSOverlay": "/home/freya/tor/seL4/src/plat/odroidc4/kernel-overlay-odroidc4_2.dts",
        },
        multikernels=2,
    ),
    BoardInfo(
