    ...
    for (;;) {
        ...
        if (x86_vmenter_result_valid) {
            if (x86_vmenter_result == SEL4_VMENTER_RESULT_FAULT) {
                ...
                microkit_vcpu_x86_deferred_resume(microkit_mr_get(SEL4_VMENTER_CALL_EIP_MR),
                                                  microkit_mr_get(SEL4_VMENTER_CALL_CONTROL_PPC_MR), microkit_mr_get(SEL4_VMENTER_CALL_INTERRUPT_INFO_MR));
            }
        }
#endif /* CONFIG_VTX */
